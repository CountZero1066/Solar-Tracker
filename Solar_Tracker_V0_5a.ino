...
//max servo_current_draw value of 110 determined via experimentation. Value will varry according to hardware used 
Serial.println("*************************************");
Serial.println("Discover min/max pan servo positions");
Serial.println("*************************************");
    servo_current_draw = analogRead(A7); 
    left_right_angle = left_right_servo.read();
    while(servo_current_draw <110){
...
Serial.println("*************************************");
Serial.println("Discover min/max tilt servo positions");
Serial.println("*************************************");
